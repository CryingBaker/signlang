...
json_file = open("/Users/atharvwadadekar/Code/SIH-project/signlang/model.json", "r")
model_json = json_file.read()
json_file.close()
model = model_from_json(model_json)
model.load_weights("/Users/atharvwadadekar/Code/SIH-project/signlang/model.h5")
